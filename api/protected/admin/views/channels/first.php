...
<h4>主栏目管理</h4>
<p>
    <a class="btn" href="<?php echo $this->createUrl('channels/pcreate'); ?>">
        添加主栏目
    </a>
</p>
<?php
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'dataProvider'=>$model->search($flag),
    ...
    'columns'=>array(
        ...
        array(
            ...
            'buttons' => array(
                ...
                'update' => array('url'=>'Yii::app()->createUrl("channels/pupdate", array("id"=>$data->id))',),
                'add' => array('label' =>'添加二级栏目',
                                'icon'=>'plus',
                                'options'=>array('style'=>'padding:0 5px;'),
                                'url'=>'Yii::app()->createUrl("channels/screate", array("id"=>$data->id))',
                                'visible' =>'$data->pid == 0'
                ),
            ),
